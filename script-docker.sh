...
# Executa a API
docker run --name=jobbie-api --net jobbie-net --env-file .env -p 1337:1337 -d jobbie-api:1.0

# Executa o aplicativo
docker run --name=jobbie-app --net jobbie-net -e VITE_BACKEND_URL=jobbie-api:1337 -p 3000:3000 -d jobbie-app:1.0
